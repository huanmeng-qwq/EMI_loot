...
public class BlockStatePropertyConditionParser implements ConditionParser {
    ...
    public List<LootTableParser.LootConditionResult> parseCondition(LootCondition condition, ItemStack stack, boolean parentIsAlternative) {
        ...
        if (block != null) {
            ...
            StatePredicate predicate = ((BlockStatePropertyLootCondition) condition).properties().orElse(null);
            if (predicate == null) {
                bsText = LText.translatable("emi_loot.condition.blockstate.predicate");
            } else
