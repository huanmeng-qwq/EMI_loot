...
public class NumberProcessors {
    ...
    public static MutableText processNumberRange(NumberRange<? extends Number> range, String exact, String between, String atLeast, String atMost, String fallback, Object... args) {
        if (!range.equals(NumberRange.IntRange.ANY) && !range.equals(NumberRange.DoubleRange.ANY)) {
            Number min = range.min().orElse(null);
            Number max = range.max().orElse(null);
