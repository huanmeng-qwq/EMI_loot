...
public class KilledByWitherLootCondition implements LootCondition {
    ...
    public static final Codec<KilledByWitherLootCondition> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codecs.createStrictOptionalFieldCodec(Codec.STRING, "type")
                .forGetter(e -> Optional.of("lootify:wither_kill"))).apply(instance, s -> new KilledByWitherLootCondition());
    });
